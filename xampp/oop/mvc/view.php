...
class View
{
    public function newPage()
    {
        ...
        <form action="index.php" method="POST">
            <div class="mb-3 mt-3">
                ...
                <input type="text" class="form-control" id="fname" placeholder="Käyttäjän etunimi" name="fname">
            </div>
            <div class="mb-3 mt-3">
                <label for="sname" class="form-label">Sukunimi:</label>
                <input type="text" class="form-control" id="sname" placeholder="Käyttäjän sukunimi" name="sname">
             </div>
            ...
            foreach ($kayttajat as $kayttaja)
    {
            ...
            echo "<td><a href='index.php?action=edit&id=" . $kayttaja['kayttajaid'] . "'>Muokkaa</a></td><td><a href='index.php?action=delete&id=" . $kayttaja['kayttajaid'] . "'>Poista</a></td></tr>";
    }
    ?>
    </table>
    <?php
    ...
    public function editPage($kayttaja) { 
        ...
        <form action="index.php" method="POST">
            <input type="hidden" name="id"
                value="<?php echo $kayttaja->getkayttajaid(); ?>">
            <div class="mb-3 mt-3">
                <label for="fname" class="form-label">Etunimi:</label>
                <input type="text" class="form-control" id="fname" placeholder="Käyttäjän etunimi" name="fname"

                value="<?php echo $kayttaja->getEtunimi(); ?>">
            </div>
            <div class="mb-3">
                <label for="sname" class="form-label">Sukunimi:</label>
                <input type="text" class="form-control" id="sname" placeholder="Käyttäjän sukunimi" name="sname"

                value="<?php echo $kayttaja->getSukunimi(); ?>">
            </div>
